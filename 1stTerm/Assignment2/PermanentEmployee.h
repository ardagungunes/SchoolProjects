...
public:
    ...
    PermanentEmployee(int mEmployeeNumber, int mEmployeeType, const string &mName, const string &mSurname,
    ...
    friend ostream& operator<<(ostream& os, const PermanentEmployee& te);
